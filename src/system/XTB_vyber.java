...
public class XTB_vyber extends eoc.xinterface.XTable {
   ...
   public Object PolkaIDu (String sMasterTbl, JTable myTable, Integer row) {
       System.out.println("MSTTB:" + sMasterTbl + " ROW:" + row);
       return "MSTTB:" + sMasterTbl + " ROW:" + row;
   }

   public Object PolkaIDu (Object o) {
       return "XACHACHA";
   }
   
   public Integer PolkaIDu () {
       return 321;
   }
