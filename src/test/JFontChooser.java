...
public class JFontChooser extends JComponent {
    ...
    public Font showDialog(Component component, String title) {
        ...
        Rectangle r = new Rectangle(300,500);
        dialog.setBounds(r);
...
//        return new Font(map);
    ...
    public void setValues(String nameF, Integer typF, Integer sizeF) {
        fontList.setSelectedValue(nameF, true);
        sizeList.setSelectedValue(sizeF, true);
        boldCheckBox.setSelected(typF == 1 || typF == 3); 
        italicCheckBox.setSelected(typF == 2 || typF == 3); ;
    }
}
