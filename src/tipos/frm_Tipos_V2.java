 ...
 * @author rvanya
 */
public class frm_Tipos_V2 extends javax.swing.JFrame {
    @Override
...
*/
    ...
    private void initComponents() {
        ...
        jTF_inputFile.setText("D:\\EaSys\\tipos\\loto5z35_2013_14.xls");
    ...
    private void jButton_NacitajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_NacitajActionPerformed
        try {
            ...
            Logger.getLogger(frm_Tipos_V2.class.getName()).log(Level.SEVERE, null, ex);
...
*/        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Tipos_V2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Tipos_V2().setVisible(true);
            }
        });
    }
