 ...
 * @author rvanya
 */
public class DObject extends javax.swing.JDialog implements eoc.IEOC_VisualObject {
     ...
     * @param modal
     */
    public DObject(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public String receiveMessage(EOC_message eocMsg) {
       ...
       String retVal = "NOTRECEIVED-in_DObject";
       try {
