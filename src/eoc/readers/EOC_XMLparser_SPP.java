...
public class EOC_XMLparser_SPP {
 
public static void main(String argv[]) {
   Short shNodeType = null;
   try {
      File fXmlFile = new File("d:/fa.xml");
      ...
      for (int temp = 0; temp < nList.getLength(); temp++) {
         ...
         if (nNode.getNodeType() == Node.ELEMENT_NODE) {
             ...
             System.out.println("NODE_TYPE:" + nNode.getNodeType() + " " + nNode.getNodeName() + " : " + getTagTextContext(eElement,nNode.getNodeName()));
