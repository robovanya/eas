 ...
 * @author rvanya
 */
public class Pnl_calendarTable extends PObject {
    /**
    ...
    int numDimRows;
    int minRowHeight;
    int headerHeight = 32;  // prepisatelny defaul - suvisi so vypoctom velkosti na obrazovket
    int firstColWidth = 70; // prepisatelny default - suvisi so vypoctom velkosti na obrazovke
    int minColWidth = 25;   // prepisatelny default - suvisi so vypoctom velkosti na obrazovke
    XD_calendar_event calendarUpdater = null; 
    volatile private boolean ctrlIsDown;
    private String mySelectionMode = "STD";
    Calendar calOriginalToday; // datum dna, cim sa system kalendarov rozbehol
                               // malo by sa to menit po preskoceni na dalsi
                               // den, pokial nechal uzivatel zapnuty PC,
                               // co znamena kompletny rebuild vsetkych 
                               // AKTUALANE PRAVE spustenych obrazoviek kalendara 
    Calendar calCurrentToday;  // Pri nabehu sa to rovna calOriginalToday
                               // potom sa to meni posunmi goToPrev-goToNext 
    
    Calendar calFirstDay;
    Calendar calLastDay;
 //   Class XPointerClass;
 //   Class YPointerClass;
//    premenne, ktore sa zatial nevyuzili
//    Object initialXPointer;
//    Object initialYPointer;
//    Object currentXPointer;
//    Object currentYPointer;
//    Object topXBoundary;
//    Object downXBoundary;
    Integer  monthMaxDay;
    Integer  displayedDays;
    CalendarOwner myCalendarOwner;
    CubeMiner cubeMinner = null;
    int lastTestedWidth = 0;
    int lastTestedHeight = 0;
    boolean bVisibleNullValues = false;
    String displayedValueType = "";
    public Integer[] selRows;
    public Integer[] selCols;
    public Color colHeadBtnColor = Color.getHSBColor((float) 0.8,(float)0.1, (float)0.99);
    public Color rowHeadBtnColor = Color.getHSBColor((float) 0.8,(float)0.13, (float)0.99);
    int lastDraggedCol = 0;
    Class jointPointClass; 
    Object currentJointPoint; 
    public String sDimension = "HourDay"; // alebo DayMonth
    public Pnl_calendarTableGroup calendarTableGroup;
    
    static JPopupMenu cellPopUpMenu;
    public boolean bOwnerGroupMode;
    ...
    // konstruktor
    public Pnl_calendarTable() {
        bOwnerGroupMode = false;
        ...
        /*
          JMenuItem item1 = new JMenuItem("This is Menu Item");
          JMenuItem item2 = new JMenuItem("This is another Menu Item");
          ...
          pop.add(item1);
          pop.add(item2);
          myTable.addMouseListener(popListener);        
        */
   }
        ...
        if (valueClassName.equals("CalendarCellTblModel")) {
            ...
            rowCnt = cmdl.getRowCount();
                if (rowCnt > 0) {
                  for (int r = 0; r < rowCnt; r++) { 
                      ...
                      String calOwnr = cev.getProperty("c_owner").toString();
                      String curUser = krn.getPermd().getCurrentUser();
                      //Kernel.staticMsg("ewent-owner:" + calOwnr + "\ncurrent-user:" + curUser);
                      item1.setForeground(calOwnr.equals(curUser)?Color.BLACK:Color.GRAY);
            ...
            cellPopUpMenu.show(e.getComponent(), e.getX(), e.getY());
                   ...
                   // maybeShowPopup(e);
                    ...
                    System.out.println("ISSNULLA: " + (calendarUpdater==null) + (tch==null));
                    if (tch != null)
...
////                    System.out.println("Ez dógozik, bazmeg down! ");
    ...
    public void fireScrollPaneResized(Component c) {
        if (cubeMinner.getsDimension().equals("Browser")) return;
    ...
    private void myTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_myTableMouseClicked
        // TODO add your handling code here:
          if (evt.getClickCount() == 2) {
                ...
                handleDoubleClick(myTable.getSelectedRow(), myTable.getSelectedColumn());
          }
    }//GEN-LAST:event_myTableMouseClicked

    public void handleDoubleClick(int row, int col) {
     // override-ovat, ked je treba v potomku   
    }
