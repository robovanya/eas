 ...
 * @author rvanya
 */
public class XDObject extends javax.swing.JDialog implements eoc.IEOC_VisualObject {
     ...
     * @param modal
     */
    public XDObject(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public String receiveMessage(EOC_message eocMsg) {
       ...
       String retVal = "NOTRECEIVED-in_XDObject";
       try {
